...
<div class="row margin-bottom">
	<div class="col-md-12 text-center">
          <?php $attributes = array("name" => "search","id"=>"search_form","class"=>"form-inline");
            echo form_open("employees/ajax_search", $attributes);
            ?>    
 ...
 <div class="table-responsive margin-bottom">          
  <table class="table">
    <thead>
      <tr>
        <th>S.No</th>
        <th><a href="<?php echo base_url();?>employees/view_list/name/<?=$order?>/<?=$page_num?>">Name</a></th>
        <th><a href="<?php echo base_url();?>employees/view_list/email/<?=$order?>/<?=$page_num?>">Email</a></th>
        <th>Mobile</th>
        <th><a href="<?php echo base_url();?>employees/view_list/create_date/<?=$order?>/<?=$page_num?>">Join Date</a></th>
        <th>Action</th>
